<div>
    ...
    <input type="text" name="name" class="input w-full border mt-2" placeholder="Enter Role Name" required>
</div>
<div class="mt-3">
    ...
    @forelse($permissions->chunk(4) as $allpermission)
        @foreach($allpermission as $permission)
            <div class="flex items-center text-gray-700 mt-2">
                <input type="checkbox" name="permissions[]" class="input border mr-2" id="vertical-checkbox-chris-evans" value="{{$permission->id}}">
